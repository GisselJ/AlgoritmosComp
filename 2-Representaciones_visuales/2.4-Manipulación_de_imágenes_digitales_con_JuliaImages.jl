...
# ╔═╡ ccf40325-3027-426f-8259-2df25c7ef00c
...
# ╔═╡ dc20000e-e313-4cad-b2b0-bb27418985cc
...
# ╔═╡ cbc37129-3634-4683-8eea-de434ec3bcf5
arte_de_pixeles = ColorTypes.RGB{Float64}[RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0); RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)  RGB{Float64}(1.0,1.0,1.0) RGB{Float64}(1.0,1.0,1.0)]

# ╔═╡ 7bdc4c15-7e6a-4c19-b280-3b2b5359994c
begin
	arte_de_pixeles[1,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[2,1] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[3,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[2,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[4,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[2,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,3] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,4] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,5] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,6] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,7] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[5,3] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[6,7] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[6,6] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[6,5] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[6,4] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[6,3] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[6,2] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[7,3] = RGB(0.290,0.33,0.441)
	arte_de_pixeles[7,6] = RGB(0.290,0.33,0.441)
...
# ╔═╡ c8d4b964-b1cc-4e26-97f2-d9df3623c120
arte_de_pixeles
